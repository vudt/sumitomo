			...
			<?php } else { ?>
				...
				<div class="um-col-alt um-col-alt-b">
					...
					<div class="um-center">
						...
						<button type="submit" value="<?php esc_attr_e( 'Reset my password', 'ultimate-member' ); ?>" class="um-button lgx-btn hvr-glow hvr-radial-out lgxsend lgx-send" id="um-submit-btn"><?php esc_attr_e( 'Reset my password', 'ultimate-member' ); ?></button>
					</div>
