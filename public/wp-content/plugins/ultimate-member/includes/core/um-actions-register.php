...
function um_add_submit_button_to_register( $args ) {
	...
	<div class="um-col-alt">
		...
		<?php } else { ?>
			...
			<div class="um-center">
				<button type="submit" value="<?php esc_attr_e( wp_unslash( $primary_btn_word ), 'ultimate-member' ) ?>" class="um-button lgx-btn hvr-glow hvr-radial-out lgxsend lgx-send" id="um-submit-btn">REGISTER</button>
			</div>
