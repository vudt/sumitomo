...
function um_add_submit_button_to_login( $args ) {
	...
	<div class="um-col-alt">
		...
		<?php } else { ?>
			...
			<div class="um-center">
				<!-- <input type="submit" value="<?php esc_attr_e( wp_unslash( $primary_btn_word ), 'ultimate-member' ); ?>" class="um-button" id="um-submit-btn" /> -->
				<button type="submit" value="<?php esc_attr_e( wp_unslash( $primary_btn_word ), 'ultimate-member' ); ?>" class="um-button lgx-btn hvr-glow hvr-radial-out lgxsend lgx-send lgx-btn-red" id="um-submit-btn">LOGIN</button>
			</div>
